...
import { CreditCard, Hash, Receipt, Settings2, Users, Zap } from "lucide-react";
    ...
    <div className="p-6 sm:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3 max-w-5xl">
        ...
        >
          ...
          <h2 className="font-semibold text-[#1A2E22]">Payments</h2>
          <p className="mt-2 text-sm text-[#6B8C74]">Connect Stripe so clients can pay invoices online with one click.</p>
        </Link>
