...
export default function BillingPlanButton({ priceId, featured = false, disabled = false }: Props) {
  ...
  const baseClasses =
    "w-full inline-flex items-center justify-center gap-2 px-3 py-3 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed";
