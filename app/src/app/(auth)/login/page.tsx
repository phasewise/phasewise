      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-[#E2EBE4] rounded-[14px] p-8 shadow-[0_4px_24px_rgba(26,46,34,0.06)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="login-email" className="text-sm text-[#3D5C48] block mb-1.5 font-medium">Email</label>
              <input
                id="login-email"
                type="email"
                value={email}
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="login-password" className="text-sm text-[#3D5C48] font-medium">Password</label>
                <Link
